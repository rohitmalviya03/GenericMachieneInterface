...
public class orderMain {
   ...
   public static void main(String[] args) throws Exception {
       ...
       */
      int port = 10001; // The port to listen on
     // int portB=10001;
...
//    
      String msg="MSH|^~\\&|LIS|LIS|HALIA|HALIA|20230921162512||OML^O33^OML_O33|20230910002512|P|2.5|||||||\r" + 
        		"PID|||230909H01200^^^LIS^PI||989262300504521^ROHITM^^||20230910|F|||^^^^^^||||||||||||||||||||N|AL\r" + 
        		"PV1||N|||||||||||||||||||||||||||||||||||||||||||\r" + 
...
//      // A connection object represents a socket attached to an HL7 server
      //Connection connection = context.newClient("localhost", 10001, useTls);
...
//       */
//      connection = context.newClient("127.0.0.1", 10004, useTls);
...
//      response = initiator.sendAndReceive(adt);
   ...
   public static class MyConnectionListener implements ConnectionListener {
      ...
      public void connectionReceived(Connection theC) {
         ...
         System.out.println("port"+theC.getRemotePort());
      }
