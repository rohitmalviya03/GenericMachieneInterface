...
public class HL7Client {
    ...
    public static void main(String[] args) throws LLPException {
        String serverHost = "192.168.112.135";
        ...
        String hl7Message="MSH|^~\\&|LIS|LIS|HALIA|HALIA|20230910002512||OML^O33^OML_O33|20230910002512|P|2.5|||||||\r" + 
          		"PID|||230909H080002^^^LIS^PI||989262300504521^demo name^^||20230910|F|||^^^^^^||||||||||||||||||||N|AL\r" + 
          		"PV1||N|||||||||||||||||||||||||||||||||||||||||||\r" + 
