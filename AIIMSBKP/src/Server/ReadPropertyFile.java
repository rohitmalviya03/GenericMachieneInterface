...
public class ReadPropertyFile
{
    ...
    public static Map getPropertyValues() {
        ...
        final String graph_path="graph_path";
            ...
            try {
                ...
                try {
                   ...
                   // ReadPropertyFile.propertyMap.put(pr, prop.getProperty(pr));
                    ...
                    ReadPropertyFile.propertyMap.put(db_name, prop.getProperty(db_name));
                    ReadPropertyFile.propertyMap.put(graph_path, prop.getProperty(graph_path));
