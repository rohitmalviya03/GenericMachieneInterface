					...
					if(msgType.equals("ORU^R01")) {
						...
						if (segment.contains("OBR")) {
							...
							if (msgPart[2].equals("NM")) {
								testCode.add(msgPart[3]);
								double value = Double.parseDouble(msgPart[5]); // Convert String to double
								String formattedValue = String.format("%.2f", value); // Format to 2 decimal places

								testValue.add(formattedValue);
							} else {
