				...
				// Messages
{
			...
			//	System.out.println("ENQ SENT : ");
				...
				output.flush();
				 ...
				 GenericServer.saveToFile("ACK  SENT :- ", GenericServer.FILE_NAME);
					...
					//	for(String strPKT:strData) {
						        		...
						        		//  GenericServer.logMessage("MSH :"+segment, Color.MAGENTA);
						        		 // System.out.println("MSH"+segment);
							      	    ...
							      	    if(msgtype.equals("O R U") ||msgtype.equals("O"+crnull+"R"+crnull+"U")||msgtype.equals("ORU") ) {  ///sending ACK when result recieved
							      	    	...
							      	    	String resACK1=START_BLOCK+"MSH|^~\\&|host||cobas pure||YYYYMMDDHHMMSS||ACK^R22^ACK|CONTROLID||2.5.1||||NE||UNICODE UTF-8|\n"
								        	 		+ "MSA|AA|CONTROLID||\r"+END_BLOCK_1+END_BLOCK_2;
								        	 		
							      	    	StringBuilder msg = new StringBuilder();
							      	    	
							      	    	
							      	    	msg.append("MSH|^~\\&|||||YYYYMMDDHHMMSS||ACK^R01|"+msID+"|P|2.3.1||||||UNICODE||").append("\n");
							      	    	msg.append("MSA|AA|"+msID);
						...
						if(msgtype.trim().equals("O R U")||msgtype.trim().equals("ORU") || msgtype.trim().equals("O"+crnull+"R"+crnull+"U")|| msgtype.trim().contains("S P M")) {
			               ...
			               //  GenericServer.logMessage("segment"+segment, Color.BLUE);
							    	if (segment.contains("OBX")&& segment.contains("NM")) {
							    		...
							    		String[] parts = segment.split("\\|");
							             	...
							             	if(tc[1].equals("WBC")|| tc[1].equals("NEU#") || tc[1].equals("LYM#") || tc[1].equals("MON#") || tc[1].equals("EOS#") || tc[1].equals("BAS#") || tc[1].equals("IMG#") || tc[1].equals("NEU%") || tc[1].equals("LYM%") || tc[1].equals("MON%") || tc[1].equals("EOS%") || tc[1].equals("BAS%") || tc[1].equals("IMG%") || tc[1].equals("RBC") || tc[1].equals("HGB") || tc[1].equals("HCT") || tc[1].equals("MCV") || tc[1].equals("MCH") || tc[1].equals("MCHC") || tc[1].equals("RDW-CV") || tc[1].equals("RDW-SD") || tc[1].equals("PLT") || tc[1].equals("MPV") || tc[1].equals("PDW") || tc[1].equals("PCT") || tc[1].equals("PLCC") || tc[1].equals("NRBC#") || tc[1].equals("NRBC%") || tc[1].equals("PLCR") ) {
							                ...
							                // if(value.equals("WBC")|| value.equals("NEU#") || value.equals("LYM#") || value.equals("MON#") || value.equals("EOS#") || value.equals("BAS#") || value.equals("IMG#") || value.equals("NEU%") || value.equals("LYM%") || value.equals("MON%") || value.equals("EOS%") || value.equals("BAS%") || value.equals("IMG%") || value.equals("RBC") || value.equals("HGB") || value.equals("HCT") || value.equals("MCV") || value.equals("MCH") || value.equals("MCHC") || value.equals("RDW-CV") || value.equals("RDW-SD") || value.equals("PLT") || value.equals("MPV") || value.equals("PDW") || value.equals("PCT") || value.equals("PLCC") || value.equals("NRBC#") || value.equals("NRBC%") || value.equals("PLCR") ) {
							                 ...
							                 System.out.println("Test Code " + tc[1]);
