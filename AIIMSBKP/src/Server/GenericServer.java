			...
			try {
				...
				for (String segment : segments1) {
					...
					if (segment.contains("MSH|")) {
						...
						mindACK.append("MSH|^~\\&|||||" + timestamp + "||ACK^RO1|" + msgControlId
				...
				if(msgType.equals("QRY^Q02")) {
					...
					String qryRepons=START_BLOCK+"MSH|^~\\&|||||TIMESTAMP||DSR^Q03|MSGCONTROL|P|2.3.1||||||ASCII|||\r"
							+ "MSA|AA|4|Message accepted|||0|\r"
							+ "ERR|0|\r"
							+ "QAK|SR|OK|\r"
							+ "QRD|20120508110131|R|D|2|||RD||OTH|||T|\r"
							+ "QRF||||||RCT|COR|ALL||\r"
							+ "DSP|1||PATID|||\r"
							+ "DSP|2||27|||\r"
							+ "DSP|3||PATNAME|||\r"
