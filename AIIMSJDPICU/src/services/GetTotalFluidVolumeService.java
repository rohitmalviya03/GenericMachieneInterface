...
public class GetTotalFluidVolumeService extends Service<Void>
{
	...
	private static GetTotalFluidVolumeService instance = null;

	public HashMap<String, String> getFluidVolume() {
		return fluidVolume;
	}

	public static GetTotalFluidVolumeService getInstance(long caseIDVal,List<String> fluidNameListVal)
	{
		if(instance == null)
		{
			instance = new GetTotalFluidVolumeService();
		}
	...
	private GetTotalFluidVolumeService() {
		super();
	}
