...
public class SaveAndGetTotalMedicationService extends Service<Void>
{
	...
	private static SaveAndGetTotalMedicationService instance = null;

	public static SaveAndGetTotalMedicationService getInstance(IntraopMedicationlog medicationLogVal,String medicationNameVal, int patientIDVal, long caseIDVal)
	{
		if(instance == null)
		{
			instance = new SaveAndGetTotalMedicationService();
		}
	...
	private SaveAndGetTotalMedicationService() {
		super();
	}
