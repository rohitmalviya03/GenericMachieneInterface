...
public interface CannulationsDao {
	 ...
	 * @throws Exception
	 */
	void createCannulationRecord(Cannulations cannulationRecord,String userName)
	        throws Exception;
	 ...
	 * @throws Exception
	 */
	Cannulations getCannulationRecord(Long patientCaseId, String userName)
	        throws Exception;
