...
public class PacketMakerOnStartByteAndEndByteBasis implements IPacketMakerStrategy
{
	private static final Logger LOG = Logger.getLogger(PacketMakerOnStartByteAndEndByteBasis.class);
	...
	public PacketMakerOnStartByteAndEndByteBasis(byte[] startBytes, byte[] endBytes)
	{
