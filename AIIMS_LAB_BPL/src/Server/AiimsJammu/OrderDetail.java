...
public class OrderDetail {
    ...
    public String samcollDate;
    public String pataddress;
    public String patward;
    public String reqdno;
	...
	public String getSamcollDate() {
		return samcollDate;
	}
	public void setSamcollDate(String samcollDate) {
		this.samcollDate = samcollDate;
	}
