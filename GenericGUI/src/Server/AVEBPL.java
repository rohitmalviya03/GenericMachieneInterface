				...
				// Messages
{
				...
				// GenericServer.logMessage("Data  RECIEVED :- " + redDataText, Color.black);
				 ...
				 GenericServer.saveToFile("Data  RECIEVED :- " + redDataText, GenericServer.FILE_NAME);
					...
					//	for(String strPKT:strData) {
						        		...
						        		//  GenericServer.logMessage("MSH :"+segment, Color.MAGENTA);
						        		 // System.out.println("MSH"+segment);
							      		...
							      		//GenericServer.logMessage("Incoming msg Type :"+msgtype, Color.BLUE);
							      		 ...
							      		 GenericServer.saveToFile("Incoming msg Type :"+msgtype, GenericServer.FILE_NAME);
							      	    ...
							      	    //	msg.append("MSA|AA|CONTROLID||").append("\n");
											...
											output.flush();
							      	    	...
							      	    	//GenericServer.logMessage("ACK SENT :" + resACK, Color.BLUE);
							      	    	 GenericServer.saveToFile("ACK SENT :" + resACK, GenericServer.FILE_NAME);
							      	    }
						        	...
						        	if(msgtype.equals("O R U") ||msgtype.trim().equals("O"+crnull+"R"+crnull+"U")||msgtype.trim().equals("ORU")) {
						        		...
						        		if (segment.trim().contains("O B R")||segment.trim().contains("O"+crnull+"B"+crnull+"R")||segment.trim().contains("OBR")) {
						        			...
						        			//GenericServer.logMessage("Sample No :  "+sampleName, Color.BLUE);
						        			 GenericServer.saveToFile("Sample No :  "+sampleName, GenericServer.FILE_NAME);
						...
						if(msgtype.trim().equals("O R U")||msgtype.trim().equals("ORU") || msgtype.trim().equals("O"+crnull+"R"+crnull+"U")|| msgtype.trim().contains("S P M")) {
			               ...
			               //  GenericServer.logMessage("segment"+segment, Color.BLUE);
							    	if (segment.contains("OBX")||segment.contains("O B X") || segment.contains("O"+crnull+"B"+crnull+"X")|| segment.trim().startsWith("O B X")||segment.startsWith(crnull+"O"+crnull+"B"+crnull+"X") ||segment.startsWith("OBX")) {
							    		...
							    		String[] parts = segment.split("\\|");
							                ...
							                // GenericServer.logMessage("segment " + segment, Color.BLUE);
							             	...
							             	if(segment.contains("G"+crnull+"L"+crnull+"U")||
							             			...
							             			tc[0].equals("YCrystalPF")||
							             			tc[0].equals("WEpitheliaPF")||
							             			tc[0].equals("DEpitheliaPF")||
							             			tc[0].equals("SEpitheliaPF")||
							             			tc[0].equals("ZDuctPF")||
							             			tc[0].equals("SDuctPF")||
							             			tc[0].equals("SpermPF")||
							             			tc[0].equals("ParasitesPF")||
							             			tc[0].equals("YeastPF")||
							             			tc[0].equals("MildewPF")||
							             			tc[0].equals("BaciIIiPF")||
							             			tc[0].equals("CocciPF")||
							             			tc[0].equals("BacterialPF")||
							             			tc[0].equals("MonocytePF")||
							             			tc[0].equals("BasophilPF")||
							             			tc[0].equals("AcidophilPF")||
							             			tc[0].equals("LymphocyteP")||
							             			tc[0].equals("NeutrophilPF")||
							             			tc[0].equals("QRbcPF")||
							             			tc[0].equals("ZRbcPF")||
							             			tc[0].equals("JRbcPF")||
							             			tc[0].equals("SmaIIRbcPF")||
							             			tc[0].equals("BigRbcPF")||
							             			tc[0].equals("LEpitheliaPF")||
							             			tc[0].equals("LDuctPF")||
							             			tc[0].equals("TDuctPF")||
							             			tc[0].equals("KDuctPF")||
							             			tc[0].equals("WbcDuctPF")||
							             			tc[0].equals("RbcDuctPF")||
							             			tc[0].equals("WCrystalPF")||
							             			tc[0].equals("CCrystalPF")||
							             			tc[0].equals("HCrystalPF")||
							             			tc[0].equals("LCrystalPF")||  //LCrystalPF
							             			tc[0].equals("NCrystalPF")||
							             			tc[0].equals("PyoidPF")||
							             			tc[0].equals("InfusorialPF")||
							             			tc[0].equals("SingularRbcP")||
							             			tc[0].equals("SingularRbcPF")||
							             			tc[0].equals("S i n g u l a r R b c P F")||
							             			tc[0].equals("WhackRbcPF")||
							             			tc[0].equals("EpitheliaPF")||
							             			tc[0].equals("DuctPF")
							             ...
							             //    GenericServer.logMessage("Test Value " + tcvalue, Color.BLUE);
							                 GenericServer.saveToFile("Test Code " + tc[0], GenericServer.FILE_NAME);
							                 GenericServer.saveToFile("Test Value " + tcvalue, GenericServer.FILE_NAME);
								            ...
								            // String result = String.format("%.1f", truncatedNumber);
							                 ...
							                 else if(tcvalue.equals("-")) {

								                 testValue.add("0");
								                  
							                 }

							                 else if(tcvalue.contains(">")) {

							                	 tcvalue= tcvalue.replaceAll(">","%3E");
							                	 testValue.add(tcvalue);
							                 }
							                 else if(tcvalue.contains("<")) {

							                	 tcvalue= tcvalue.replaceAll("<","%3C");
							                	 testValue.add(tcvalue);
							                 }
							                 //%3E
							//continue;
						       ...
						       if(msgtype.trim().equals("O R U")||msgtype.trim().equals("ORU") || msgtype.trim().equals("O"+crnull+"R"+crnull+"U")|| msgtype.trim().contains("S P M")) {
								...
								//     System.out.println("Sample No:"+sampleName);
								 ...
								 //     System.out.println("Total Test Entered"+testCode.size());  
							        GenericServer.saveToFile("Total Test Entered"+testCode.size(), GenericServer.FILE_NAME);
									
								      mp.put("TestCode", testCode);
								      mp.put("TestValue", testValue);
								     	//mp.put("SampleNO",sampleNo);
								     	 
								        System.out.println("RM"+testCode);  
